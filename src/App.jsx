    ...
    <div className=" mb-4">
      ...
      <div className="flex">
        <input
          ...
          className="p-2 border border-white-200 rounded-l-md"
        />
        <button
...
function App() {
  ...
  return (
    <div className="p-8 bg-black">
      <h1 className="text-2xl mb-4 text-center text-white">ALBUM-LIST-APP</h1>
      <AddAlbumBar onAddAlbum={handleAddAlbum} />
      {albums.map((album) => (
        <div
          key={album.id}
          className=" text-white border border-white-200 p-4 rounded-md shadow-md mb-4"
        >
